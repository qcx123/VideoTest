...
@interface DKScrollView () <UIScrollViewDelegate>
...
//        _downLive = [[VideoInfoModel alloc] init];
        ...
        _upperLive = (VideoInfoModel *)_lives[_currentIndex];
        _middleLive = (VideoInfoModel *)_lives[_currentIndex + 1];
        _downLive = (VideoInfoModel *)_lives[_currentIndex + 2];
        
//        if (_currentIndex == 0) {
//            _upperLive = (VideoInfoModel *)[_lives firstObject];
//        } else {
//            _upperLive = (VideoInfoModel *)_lives[_currentIndex];
//        }
//        if (_currentIndex == _lives.count - 1) {
//            _downLive = (VideoInfoModel *)_lives[_lives.count - 1];
//        } else {
//            _downLive = (VideoInfoModel *)_lives[_currentIndex];
//        }
